<template>
  <div class = "flex flex-col gap-4">
    <input v-model = "color" type = "text" placeholder="Insert the willing color" class = "mt-4 text-white hover:text-black hover:bg-white text-center border-2 w-[800px]" :style = "{backgroundColor: color, borderColor: color}">
